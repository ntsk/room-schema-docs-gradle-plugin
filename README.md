...
[![Gradle Plugin Portal](https://img.shields.io/badge/gradle%20plugin-1.5.2-blue)](https://plugins.gradle.org/plugin/jp.ntsk.room-schema-docs)
...
```kotlin
plugins {
    id("jp.ntsk.room-schema-docs") version "1.5.2"
}
```
